...
class DataProcessor:
    def process_data(self,Outside_Diameter_OD, Nominal_Wall_Thickness_tnom, Fabrication_Thickness_Tolerance_tfab, Corrosion_Allowance_tcorr, Ovality_of_Pipe_Oo,SMYS_σsmys,SMTS_σsmts,Derating_value_temp_yieldStress_fy_temp,Derating_value_temp_tensileStress_fu_temp,Youngs_Modulus_E ,Poission_s_Ratio_ν ,Maximum_Fabrication_Factor_alpha_fab,Pd,ptest_value,Pmin,Elevation_at_Pressure_Reference_Level_href,Elevation_level_at_Pressure_Point_hl ,Product_Density_ρcont,Density_of_relevant_test_medium_ρt,Incidental_to_Design_Pressure_Ratio_gamma_inc,Max_Water_Depth_WDmax,Sea_Water_Density_ρsea,Max_Elevation_wrt_MSL_hmax,Min_Elevation_wrt_MSL_hmin,Plt ):
        ...
        processed_data = {
            'od': Outside_Diameter_OD,
            'tnom': Nominal_Wall_Thickness_tnom,
            'tfab': Fabrication_Thickness_Tolerance_tfab,
            'tcorr': Corrosion_Allowance_tcorr,
            'oo': Ovality_of_Pipe_Oo,
            'SMYS': SMYS_σsmys,
            'SMTS': SMTS_σsmts,
            'fy_temp': Derating_value_temp_yieldStress_fy_temp,
            'fu_temp': Derating_value_temp_tensileStress_fu_temp,
            'E': Youngs_Modulus_E,
            'v': Poission_s_Ratio_ν,
            'alpha_fab': Maximum_Fabrication_Factor_alpha_fab,
            'pd': Pd,
            'ptest': ptest_value,
            'Pmin': Pmin,
            'href': Elevation_at_Pressure_Reference_Level_href,
            'h': Elevation_level_at_Pressure_Point_hl,
            'rho_cont':Product_Density_ρcont ,
            'rho_t': Density_of_relevant_test_medium_ρt,
            'gamma_inc': Incidental_to_Design_Pressure_Ratio_gamma_inc,
            'WDmin': Max_Water_Depth_WDmax,
        ...
        Depth =  Max_Water_Depth_WDmax + Max_Elevation_wrt_MSL_hmax

        Pressure_testFactor_gamma_SC_LB = 1.196
